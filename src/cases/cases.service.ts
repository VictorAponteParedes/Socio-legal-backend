...
export class CasesService {
    ...
    async createProposal(caseId: number, lawyerId: string, createProposalDto: CreateProposalDto) {
    ...
    async acceptProposal(caseId: number, proposalId: number, clientId: string) {
        ...
        if (caseEntity.clientId !== clientId) {
            throw new BadRequestException('No tienes permiso para aceptar propuestas de este caso');
        }
